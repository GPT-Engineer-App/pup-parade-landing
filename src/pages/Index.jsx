      ...
      <footer className="bg-blue-800 text-white py-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-xl font-semibold mb-4">Doggy Paradise</h3>
              <p className="text-blue-200">Bringing joy to dogs and their humans since 2024.</p>
            </div>
            <div>
              <h3 className="text-xl font-semibold mb-4">Quick Links</h3>
              <ul className="space-y-2">
                <li><a href="/breeds" className="text-blue-200 hover:text-white">Dog Breeds</a></li>
                <li><a href="/adoption" className="text-blue-200 hover:text-white">Adoption</a></li>
                <li><a href="/care" className="text-blue-200 hover:text-white">Dog Care</a></li>
                <li><a href="/contact" className="text-blue-200 hover:text-white">Contact Us</a></li>
              </ul>
            </div>
            <div>
          ...
          <div className="mt-8 border-t border-blue-700 pt-8 text-center text-blue-200">
